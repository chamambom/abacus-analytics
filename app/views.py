...
def view_my_isp_ratings():
    ...
    bar_chart.add('Reputation', ratings_value)
...
def view_overall_isp_ratings():
    ...
    if not kpi_name:
        ...
        pie_chart = pygal.Pie()
        pie_chart.title = 'ISP (in %)'
        pie_chart.add('Zol', 36.3)
        pie_chart.add('Powertel', 4.5)
        pie_chart.add('Telco', 2.3)
